...
convolutional_layer parse_convolutional(dlist *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(dlist *options, size_params params)
{
...
layer parse_rnn(dlist *options, size_params params)
{
...
layer parse_gru(dlist *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(dlist *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
connected_layer parse_connected(dlist *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
softmax_layer parse_softmax(dlist *options, size_params params)
{
...
layer parse_yolo(dlist *options, size_params params)
{
...
layer parse_region(dlist *options, size_params params)
{
...
detection_layer parse_detection(dlist *options, size_params params)
{
...
cost_layer parse_cost(dlist *options, size_params params)
{
...
crop_layer parse_crop(dlist *options, size_params params)
{
...
layer parse_reorg(dlist *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
layer parse_reorg_old(dlist *options, size_params params)
{
    printf("\n reorg_old \n");
    int stride = option_find_int(options, "stride", 1);
    int reverse = option_find_int_quiet(options, "reverse", 0);
...
maxpool_layer parse_maxpool(dlist *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(dlist *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(dlist *options, size_params params)
{
...
layer parse_normalization(dlist *options, size_params params)
{
...
layer parse_batchnorm(dlist *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(dlist *options, size_params params, network net)
{
...
layer parse_activation(dlist *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_upsample(dlist *options, size_params params, network net)
{
...
route_layer parse_route(dlist *options, size_params params, network net)
{
...
void parse_net_options(dlist *options, network *net)
{
...
{
    dlist *sections = read_cfg(filename);
